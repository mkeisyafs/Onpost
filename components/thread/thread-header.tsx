...
export function ThreadHeader({ thread, postCount, onDeleted }: ThreadHeaderProps) {
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              All posts and comments will also be permanently deleted.
            </DialogDescription>
          </DialogHeader>

          <div className="my-4 p-4 rounded-lg bg-muted/50 border">
            <p className="font-medium text-foreground line-clamp-2">{thread.title}</p>
